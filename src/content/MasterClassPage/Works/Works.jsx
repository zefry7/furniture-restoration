...
function Works() {
    ...
    return <section className="works">
        <div className="works__content">
            <div className="works__info opacity-effect section-obs">
                <h2 className="works__info-text">{data?.info?.text}</h2>
                <MyButton class="works__info-button tab-index" text={data?.info?.button?.text}/>
            </div>
            <div className="works__block opacity-effect section-obs">
                ...
                <MyButton class="works__block-button tab-index" text={data?.button?.text}/>
            </div>
        </div>
    </section>
}
